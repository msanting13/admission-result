...
CREATE TABLE `admission_result` (
  ...
  `guidance_counselor` varchar(50) NOT NULL,
...
INSERT INTO `admission_result` (`id`, `examiner_info_id`, `entrace_rating_id`, `preferred_course_id_1`, `preferred_course_id_2`, `guidance_counselor`, `exam_at`, `is_delete`) VALUES
(1, 1, 1, 9, 1, 'JOAN A. MARTIZANO ZARTIGA,MA,RGC', 1525873094, 'NO'),
(10, 10, 10, 1, 1, 'JOAN A. MARTIZANO ZARTIGA,MA,RGC', 1525888633, 'NO');
...
(1, 1, 'christopher', 'P', 'vistal', 'Male', '1997-01-06', 'noimage.jpg\r\n');
